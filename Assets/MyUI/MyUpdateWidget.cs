...
public class MyUpdateWidget : StatefulWidget
{
    private State currentState;

    public delegate Widget WidgetBuilder(BuildContext context);

    public MyUpdateWidget(
        Key key = null,
    ...
    {
        currentState = new _CustomActivityIndicatorStateB();
        return currentState;
    }
}

class _CustomActivityIndicatorStateB : State<MyUpdateWidget>, TickerProvider
{
